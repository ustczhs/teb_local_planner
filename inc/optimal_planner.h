...
protected:
  ...
  /**
   * @brief Add all edges (local cost functions) for enforcing Frenet corridor
   * constraints
   * @see buildGraph
   * @see optimizeGraph
   */
  void AddEdgesFrenetCorridor();
...
private:
  ...
  boost::shared_ptr<FrenetReference>
      frenet_ref_; //!< Frenet reference for corridor constraints
  std::pair<bool, Twist>
